...
print("开始测试......")
train_loss,_,_ = multi_step_model_run.test(train_dataset_t2, 'my_tcn_mlp_bias.ckpt') #计算训练集损失
val_loss,_,_ = multi_step_model_run.test(val_dataset_t2, 'my_tcn_mlp_bias.ckpt') #计算验证集损失
test_loss,preds,labels = multi_step_model_run.test(test_dataset_t2, 'my_tcn_mlp_bias.ckpt') #计算测试集损失
